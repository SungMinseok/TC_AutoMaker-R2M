...
# Form implementation generated from reading ui file '230421.ui'
#
...
"font : bold")
        ...
        self.combox_doctype_2 = QtWidgets.QComboBox(self.centralwidget)
        self.combox_doctype_2.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combox_doctype_2.sizePolicy().hasHeightForWidth())
        self.combox_doctype_2.setSizePolicy(sizePolicy)
        self.combox_doctype_2.setMinimumSize(QtCore.QSize(0, 0))
        self.combox_doctype_2.setMaximumSize(QtCore.QSize(1888888, 23))
        font = QtGui.QFont()
        font.setFamily("맑은 고딕")
        font.setPointSize(9)
        self.combox_doctype_2.setFont(font)
        self.combox_doctype_2.setStyleSheet("background-color: rgb(155, 194, 230);")
        self.combox_doctype_2.setInsertPolicy(QtWidgets.QComboBox.InsertAtBottom)
        self.combox_doctype_2.setIconSize(QtCore.QSize(16, 15))
        self.combox_doctype_2.setPlaceholderText("")
        self.combox_doctype_2.setObjectName("combox_doctype_2")
        self.combox_doctype_2.addItem("")
        self.combox_doctype_2.addItem("")
        self.horizontalLayout_3.addWidget(self.combox_doctype_2)
...
"font: bold")
        ...
        self.combox_doctype_2.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.combox_doctype_2.setItemText(0, _translate("MainWindow", "KR"))
        self.combox_doctype_2.setItemText(1, _translate("MainWindow", "TW"))
